...
class Ingredient(Base):
    ...
    supplier_sales_unit_code: Mapped[str | None] = mapped_column(String(50), nullable=True)
    supplier_sales_unit_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    supplier_standard_unit_code: Mapped[str | None] = mapped_column(String(50), nullable=True)
    supplier_standard_unit_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    supplier_sales_factor: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
    ...
    package_weight_amount: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
    package_weight_unit: Mapped[str | None] = mapped_column(String(20), nullable=True)
    package_volume_amount: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
    package_volume_unit: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    supplier_is_orderable: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    supplier_order_status_code: Mapped[str | None] = mapped_column(String(50), nullable=True)
    supplier_order_status_description: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    last_manual_review_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    manual_note: Mapped[str | None] = mapped_column(Text, nullable=True)
    awaiting_import_match: Mapped[bool] = mapped_column(
